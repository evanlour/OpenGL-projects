...
int main(){
    ...
    point_light_source demo_point_light(glm::vec3(0.25f), glm::vec3(0.25f), glm::vec3(0.25f), 1.0f, 0.045, 0.0075);
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        for(int i = 0; i < point_lights_vec.size(); i++){
            ...
            move_cube(point_lights_vec[i].model, point_lights_vec[i].pos, frame_time, matrix_floor.center, i, 0);
        }
        ...
        for(int i = 0; i < normal_cube_vec.size(); i++){
            ...
            move_cube(normal_cube_vec[i].model, normal_cube_vec[i].pos, frame_time, matrix_floor.center, i, 1);
        }
        ...
        for(int i = 0; i < mixed_cube_vec.size(); i++){
            ...
            move_cube(mixed_cube_vec[i].model, mixed_cube_vec[i].pos, frame_time, matrix_floor.center, i, 2);
        }
        ...
        for(int i = 0; i < normal_map_cube_vec.size(); i++){
            ...
            move_cube(normal_map_cube_vec[i].model, normal_map_cube_vec[i].pos, frame_time, matrix_floor.center, i, 3);
        }
...
void add_random_item(){
    ...
    if(random_num == 0){
        point_light_source point_light(glm::vec3(0.25f), glm::vec3(0.25f), glm::vec3(0.25f), 1.0f, 0.045, 0.0075);
