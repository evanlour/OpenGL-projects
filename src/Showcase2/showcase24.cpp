...
/**
 * @brief This function processes the keyboard inputs given to the window.
 * @tparam window The window in which the keyboard inputs are given to.
 * @tparam frame_time the frame time between the current and last frame.
 */
void process_keyboard_input(GLFWwindow* window, float frame_time);
/**
 * @brief The function used to process mouse input.
 * @tparam givenMousePositionX The current x axis mouse position
 * @tparam givenMousePositionY The current y axis mouse position
 */
void process_mouse_input(GLFWwindow* window, double givenMousePositionX, double givenMousePositionY);
/**
 * @brief The function used to process scroll input.
 * @tparam givenScrollOffsetX The x offset of the scroll.
 * @tparam givenScrollOffsetY The y offset of the scroll.
 */
...
float quadratic_values[] = {0.2f, 0.07f, 0.032f, 0.017f, 0.0075f};
bool light_flags[] = {true, true, true, true, true, true};
bool global_point_light_flag = true;
bool global_direct_light_flag = true;
int main(){
    //Program Setup
    GLFWwindow* window = initiate("Showcase 24");
    GLuint cube_VAO = create_color_VAO(vertices, sizeof(vertices));
    GLuint cube_program = create_shader_program("./res/VertexShader_21.txt", "./res/FragmentShader_21.txt");
    GLuint light_program = create_shader_program("./res/Vertex_light_21.txt", "./res/Fragment_light_21.txt");
