...
int main(){
    //Program Setup
    GLFWwindow* window = initiate("Showcase 22 (Press CAPS LOCK to change polygon and TAB for wireframe!)");
    GLuint polygon_program = create_shader_program("./res/VertexShader_12.txt", "./res/FragmentShader_12.txt");
